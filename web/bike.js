...
tankette.OrangeWire = new THREE.MeshBasicMaterial( {color: 0x888800,
                                             wireframe: true});
tankette.Bike = function(model_name, x, y, z, xr, yr, zr, s) {
  this.x = x;
  this.y = y;
  this.z = z;
  ...
  // Hitboxes:
  this.hitbox_geo = new THREE.BoxGeometry(6, 6, 2.5);
  ...
  mloader.load(model_name + ".mtl",
    function(materials) {
        ...
        object.position.x = 3.0;  // bike specific.  Really need to instance..
        ...
        // object.rotation.z = Math.PI * 0.5; // yaw
